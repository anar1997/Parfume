            ...
            <div className={`my-16`}>
                <div className={`w-2/4 mx-auto`}>
                    <input
                        ...
                        className="p-2 w-80 border border-gray-300 rounded-lg mb-12"
                    />
                </div>
                {perfumes.map((perfume) => (
                    <div className={`flex flex-row justify-around w-2/4 h-20 rounded-lg shadow-md brightness-125 contrast-200hover:-translate-y-1 hover:scale-110 hover:bg-slate-900 duration-300  bg-gray-500 mb-5 mx-auto`}>
